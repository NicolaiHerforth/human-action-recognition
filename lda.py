...
def select_n_components(var_ratio,goal_var: float) -> int:
    ...
    for explained_variance in var_ratio:
        ...
        print(n_components,explained_variance)
...
n_components = select_n_components(lda.explained_variance_ratio_,0.99)

#Run the LDA with the optimal number of components:
lda2 = LDA(n_components=n_components)
lda2.fit(X_train,y_train)

#Transforming the matrices:
X_train2 = lda2.transform(X_train)
